...
public class MacroDefine {
    ...
    public void macroInitialize(String input){
        ...
        codeTemp = reader("src/sicxe/Outputs/temp.asm");
        String sic = sicFile(codeTemp);

        //escrever arquivo
        try{
            String path = "src/sicxe/Outputs/parsed.sic";
            BufferedWriter writer = new BufferedWriter(new FileWriter(path));
